...
export function DailyCoinsButton() {
  ...
  return (
    <>
      <Button onClick={() => setShowModal(true)} className="w-full bg-gradient-to-r from-warning to-chart-5 hover:from-warning/90 hover:to-chart-5/90 rounded-xl gap-2 glow-sm">
          ...
          <div className="p-6 space-y-4">
            <div className="text-center">
              <div className="h-20 w-20 rounded-2xl bg-warning/20 flex items-center justify-center mx-auto mb-4">
                <Image src="https://i.gifer.com/origin/e0/e02ce86bcfd6d1d6c2f775afb3ec8c01_w200.gif" alt="Coins" width={50} height={50} unoptimized />
              </div>
              <h2 className="text-2xl font-bold text-foreground mb-2">Daily Coins</h2>
              <p className="text-muted-foreground">Claim your free 20 coins every 24 hours!</p>
            </div>
            ...
            {result ? (
              ...
              <Button onClick={handleClaim} disabled={isClaiming} className="w-full bg-warning hover:bg-warning/90 rounded-xl h-12">
                {isClaiming ? (
                  <>
