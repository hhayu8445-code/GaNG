# 🔥 UDG V 6.0 Decrypt Bot

**A powerful FiveM resource decryption bot for Discord with a web interface.**

[![Discord](https://img.shields.io/badge/Discord-Join%20Us-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/ajUReRDKv2)
...
New-NetFirewallRule -DisplayName "UDG Web Server" -Direction Inbound -LocalPort 3000 -Protocol TCP -Action Allow
```
...
**Endpoint**: `http://https://fivemtools.net/api/decrypt`
...
- 💬 **Discord**: [discord.gg/ajUReRDKv2](https://discord.gg/ajUReRDKv2)
