...
import { Lock, Download, Shield, AlertTriangle, Package, CheckCircle, Clock, Key, MessageSquare, ThumbsUp, Eye, Calendar, User } from "lucide-react"
  ...
  const [forumPosts] = useState<ForumPost[]>([
    {
      ...
      content: "Use /decrypt command in Discord to upload your encrypted files. Bot will process and give you a Download ID to use on this website.",
      likes: 245,
      views: 1823,
      replies: 34,
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base text-muted-foreground">Download decrypted files from Discord bot</p>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="lg:col-span-2 space-y-4 md:space-y-6">
                    ...
                    <div className="bg-background/50 rounded-lg p-4 mb-4">
                      <ol className="text-sm text-muted-foreground text-left space-y-2">
                        ...
                        <li className="flex gap-2">
                          ...
                          <span>Use command: <code className="bg-primary/20 text-primary px-2 py-0.5 rounded font-mono">/decrypt</code></span>
                        </li>
                        <li className="flex gap-2">
              ...
              <div className="space-y-3">
                ...
                {forumPosts.map((post) => (
                  <div key={post.id} className="glass rounded-2xl overflow-hidden border border-border/50 hover:border-primary/30 transition-colors">
                    <div className="p-4 md:p-5">
                      <div className="flex gap-3 md:gap-4">
                        <img src={post.avatar} alt={post.author} className="h-10 w-10 md:h-12 md:w-12 rounded-full bg-secondary" />
